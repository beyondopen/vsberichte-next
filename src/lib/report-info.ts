// Ported from verfassungsschutzberichte.de/src/report_info.py

/** [abbreviation, fullName] tuples for all 16 German states */
...
/** First year a jurisdiction started publishing reports */
export const startYear: Record<string, number> = {
  'Sachsen-Anhalt': 1992,
  'Thüringen': 1992,
  'Niedersachsen': 1984,
  'Hamburg': 1993,
...
/** Years where no report was published for a given jurisdiction */
export const noReports: Record<string, number[]> = {
  'Sachsen-Anhalt': [],
  'Thüringen': [2014],
  'Niedersachsen': [],
  'Hamburg': [],
...
/** Special title overrides (e.g. combined years like "1992/1993") */
export const titleOverrides: Record<string, Record<number, { title: string }>> = {
...
/** Legal challenges related to report content */
export const changes: Record<string, Record<number, [string, string][]>> = {
  'Bayern': {
    2019: [
      [
...
/** Annotations about specific report editions */
export const comments: Record<string, Record<number, string[]>> = {
  'Sachsen-Anhalt': {
    2012: [
...
export const documentTypeLabels: Record<string, string> = {
  ...
  flyer: 'Flyer',
  parlamentarisch: 'Parlamentarische Fassung',
}
