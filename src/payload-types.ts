...
export interface Document {
  ...
  pdf: number | Media;
  /**
   * Wird automatisch bei der Verarbeitung gesetzt.
   */
...
export interface PayloadJob {
  ...
  log?:
    ...
    | null;
  taskSlug?: ('inline' | 'processPdf') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskProcessPdf".
 */
export interface TaskProcessPdf {
  input: {
    documentId: number;
  };
  output?: unknown;
